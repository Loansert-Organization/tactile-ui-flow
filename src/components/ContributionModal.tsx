        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            <p className="text-sm text-blue-300">
              A USSD prompt will be sent to your phone to complete the payment via Mobile Money.
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-3 rounded-lg border border-white/20 hover:bg-white/10 transition-colors"
            >
              Cancel
            </button>
            <GradientButton
