    ...
    <div className="wizard-step space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <GlassCard variant="strong" className="p-4 sm:p-6 space-y-4 sm:space-y-6 hover:scale-[1.01] transition-all duration-300 bg-white/20 dark:bg-black/20">
        <div className="space-y-2">
          <label 
            htmlFor="basket-name"
            className="block text-foreground font-semibold text-base sm:text-lg flex items-center gap-2"
          >
          ...
          {errors.name && (
            <p id="name-error" className="text-red-400 text-sm sm:text-base animate-fade-in font-medium" role="alert">
