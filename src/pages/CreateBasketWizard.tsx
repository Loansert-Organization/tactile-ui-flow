        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Lakers Championship Ring Fund"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe what you're collecting for..."
  ...
  return (
    <div className="flex-1 flex flex-col">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`w-5 h-5 rounded-full border-2 ${
                privacy === 'public' ? 'border-pink-500 bg-pink-500' : 'border-gray-400'
              }`}>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Only people with the code can join</p>
              </div>
              <div className={`w-5 h-5 rounded-full border-2 ${
                privacy === 'private' ? 'border-pink-500 bg-pink-500' : 'border-gray-400'
              }`}>
      ...
      <GradientButton
        variant="primary"
        className="w-full mt-6"
        onClick={() => navigate('/create/step/3')}
      >
        Next
        <ArrowRight className="w-5 h-5 ml-2" />
      </GradientButton>
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <GradientButton
        variant="primary"
        className="w-full mt-6"
        onClick={() => navigate('/create/step/4')}
      >
        Next
        <ArrowRight className="w-5 h-5 ml-2" />
      </GradientButton>
